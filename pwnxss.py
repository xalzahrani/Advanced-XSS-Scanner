...
epilog="""
Github: https://github.com/xalzahrani/advanced-xss-scanner
Version: 0.1 Beta
"""
def check(getopt):
...
def start():
	...
	pos_opt.add_argument("--list",metavar="",help="Load wordlist payload")
	...
	if getopt.u:
		core.main(getopt.u,getopt.proxy,getopt.user_agent,check(getopt),getopt.cookie,getopt.list,getopt.method)
